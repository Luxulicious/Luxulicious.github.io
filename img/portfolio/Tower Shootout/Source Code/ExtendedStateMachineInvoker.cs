...
[Serializable]
public class OnStateEnterEvent : QuickEvent<Animator, AnimatorStateInfo, int> { }

[Serializable]
public class OnStateUpdateEvent : QuickEvent<Animator, AnimatorStateInfo, int> { }

[Serializable]
public class OnStateExitEvent : QuickEvent<Animator, AnimatorStateInfo, int> { }
